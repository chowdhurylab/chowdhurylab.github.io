openPTM evidence workbench

Open locally
- Double-click index.html.
- Open openPTM.html is an alternate entry point to the same workbench.

Publish on a website
- Upload index.html together with PTM_family_database_audit_final_2026-08-14.xlsx.
- Keep both files in the same folder so the workbook download link works.
- Also include openptm-disease-connections-2026-09-24.csv and .json for companion-data downloads.

Snapshot details
- Sheets: 9 (Summary, Methods, Family Ledger, Coverage Matrix, Resource Roster, Verified Totals, Rare Audit, Gap Audit A, Gap Audit B)
- Data rows: 546 (111 PTM families, 70 audited resources, 72 verified totals, 75 rare-candidate audits, 68 gap audits)
- Workbook audit date: 2026-08-14 (unchanged)
